...
const CardCountry = ({ id, img, text, heading }) => {
  return (
    <Link to={`/CountryDetails/${id}`}>
      <div className=" transition ease-in-out delay-10 hover:-translate-y-1 hover:scale-10 hover:bg-base-200 duration-300 card border border-slate-700 card-compact p-0 bg-base-100 w-full shadow-xl hover:shadow-2xl">
        <figure>
